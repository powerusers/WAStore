...
const messages = {
  en: {
    ...
    "orders.subtitle": "Enter your order ID from checkout and the phone number you used",
    "orders.orderRef": "Order ID",
    "orders.orderRefPlaceholder": "8-character code (e.g. A1B2C3D4)",
    "orders.orderRefRequired": "Enter the 8-character order ID from your confirmation.",
    "orders.phonePlaceholder": "10-digit mobile number",
    "orders.track": "Track order",
    "orders.none": "No order found. Check the order ID and phone number.",
  ...
  hi: {
    ...
    "orders.subtitle": "चेकआउट का ऑर्डर ID और इस्तेमाल किया गया फ़ोन नंबर दर्ज करें",
    "orders.orderRef": "ऑर्डर ID",
    "orders.orderRefPlaceholder": "8 अक्षर का कोड (जैसे A1B2C3D4)",
    "orders.orderRefRequired": "पुष्टि में दिया 8 अक्षर का ऑर्डर ID दर्ज करें।",
    "orders.phonePlaceholder": "10 अंकों का मोबाइल नंबर",
    "orders.track": "ऑर्डर ट्रैक करें",
    "orders.none": "कोई ऑर्डर नहीं मिला। ऑर्डर ID और फ़ोन नंबर जाँचें।",
